...
public class ApkAdapter extends BaseQuickAdapter<String, BaseViewHolder> {
    private Context mContext;
    private HashSet<Integer> mSelected;

    public ApkAdapter(@Nullable List<String> data, Context context) {
    ...
    protected void convert(BaseViewHolder helper, String item) {
        ...
        helper.setText(R.id.item_apk_filename, file.getName());
