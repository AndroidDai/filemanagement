...
public class ZipAdapter extends BaseQuickAdapter<String, BaseViewHolder> {
    private Context mContext;
    private HashSet<Integer> mSelected;

    public ZipAdapter(@Nullable List<String> data, Context context) {
        super(R.layout.item_zip, data);
        mContext = context;
    ...
    protected void convert(BaseViewHolder helper, String item) {
        ...
        helper.setText(R.id.item_zip_name , file.getName());
    }
